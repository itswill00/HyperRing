<template>
  <svg :width="size" :height="size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon">
    <g v-if="name === 'sliders' || name === 'tune'">
    ...
    <g v-else-if="name === 'bolt' || name === 'charge'">
    ...
    <g v-else-if="name === 'chip' || name === 'cpu'">
    ...
    <g v-else-if="name === 'monitor' || name === 'auto'">
      <rect x="2" y="3" width="20" height="14" rx="2" ry="2" />
      <line x1="8" y1="21" x2="16" y2="21" />
      <line x1="12" y1="17" x2="12" y2="21" />
    </g>

    <g v-else-if="name === 'circle' || name === 'lens'">
    ...
    <g v-else-if="name === 'skip-forward'">
      <polygon points="5 4 15 12 5 20 5 4" />
      <line x1="19" y1="5" x2="19" y2="19" />
    </g>

    <g v-else-if="name === 'skip-back'">
